...
## Objectif du projet :
Créer un portfolio web personnel en utilisant Jekyll, un générateur de site statique, hébergé sur GitHub Pages, avec un design personnalisé et des projets intégrés.

## Étapes du projet et Livrables
...
4. **Configurer GitHub Pages** (1h)  
   ...
   **Livrable :** Site Jekyll disponible sur GitHub Pages avec un domaine temporaire.
